<%@ Page Title="Управление на профила" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="WebApplication1.Account.Manage" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="passwordForm">
        ...
        <p>Вие сте влезли като <strong><%: User.Identity.Name %></strong>.</p>
        ...
        <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
            ...
            <fieldset>
                ...
                <ol>
                    ...
                    <li>
                        <asp:Label runat="server" AssociatedControlID="confirmPassword">Потвърдете паролата</asp:Label>
            ...
            <asp:ChangePassword runat="server" CancelDestinationPageUrl="~/" ViewStateMode="Disabled" RenderOuterTable="false" SuccessPageUrl="Manage?m=ChangePwdSuccess">
                <ChangePasswordTemplate>
                    ...
                    <fieldset class="changePassword">
                        ...
                        <ol>
                            <li>
                                <asp:Label runat="server" ID="CurrentPasswordLabel" AssociatedControlID="CurrentPassword">Настояща парола</asp:Label>
                            ...
                            <li>
                                <asp:Label runat="server" ID="NewPasswordLabel" AssociatedControlID="NewPassword">Нова парола</asp:Label>
                            ...
                            <li>
                                <asp:Label runat="server" ID="ConfirmNewPasswordLabel" AssociatedControlID="ConfirmNewPassword">Потвърдете новата парола</asp:Label>
                        ...
                        <asp:Button runat="server" CommandName="ChangePassword" Text="Промяна на паролата" ValidationGroup="ChangePassword" />
                    </fieldset>
                </ChangePasswordTemplate>
            </asp:ChangePassword>
        </asp:PlaceHolder>
